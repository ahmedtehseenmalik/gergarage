  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'customers.php' ?> ">Delete Customer</a></li>
      </ol>
    </section>
...
$(document).ready(function(){
  ...
  window.location.replace("<?= $config['admin_url'] . 'customers.php' ?>");
   });
  ...
  window.location.replace("<?= $config['admin_url'] . 'customers.php' ?>");
   ...
   $('#btnconfirmed').click(function(){
    window.location.replace("<?= $config['admin_url'] . 'customer-delete-confirmed.php?customerid='.$customer_id ?>");
