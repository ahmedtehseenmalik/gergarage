  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'customers.php' ?> ">Customers</a></li>
      </ol>
    </section>
        ...
        <div class="box-body">
           <table id="example1" class="table table-bordered table-hover">
                ...
                <?php
                  ...
                  <td><?= $row['country'] ?></td>
                  <td>
                    <span><a href="<?= $config['admin_url'] ?>edit-customer.php?customerid=<?= $row['customer_id'] ?>"><i class="fa fa-edit fa-2x"></i></a></span>  <span> <a href="<?= $config['admin_url'] ?>delete-customer.php?customerid=<?= $row['customer_id'] ?>"><i class="fa fa-trash fa-2x"></i></a></span>
                  </td>
                </tr>
                <?php }  } ?>
            </tbody>
