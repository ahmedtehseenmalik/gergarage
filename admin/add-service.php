          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="servicename" name="servicename" aria-describedby="servicename" placeholder="Service Name">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="servicecost">Service Cost*</label>
                <input type="number" class="form-control" id="servicecost" name="servicecost" aria-describedby="servicecost" placeholder="Service cost">
              </div>
            </div>
          </div>
          <div class="row">
  ...
  $('#form_submit').click(function(){ 
    $("#bookingform").validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          url : "<?php echo $config['admin_url'] ?>ajax/add-service.php",
          type :"POST",
          data: form_data,
          success: function(msg){
            if(msg == 'serviceerror'){
              ...
              $("#form_submit").attr("disabled", true);
              $("#summary").html('<div class="alert alert-success"><p>Service Done!</p></div>');
              setTimeout(function(){
                window.location.reload(1);
              }, 2000);
            }
