  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'roaster.php' ?> ">Roaster</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                	$resultbooking = getallUnAssignedBookings();
                  ...
                  <td><?= $row['status'] ?></td>
                  <td>  <a href="assign-booking.php?bookingid=<?= $row['booking_id'] ?>" > <span class=" fa fa-arrow-circle-right fa-2x"></span> </a> </td>
                </tr>
                <?php }  } ?>
            </tbody>
              </table>
