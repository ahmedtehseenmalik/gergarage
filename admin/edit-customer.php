...
$customer_id = intval($_GET['customerid']);
	...
	$customer = getonecustomer($customer_id);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'customers.php' ?> ">Edit Customer</a></li>
      </ol>
    </section>
        ...
        <form  id="bookingform" name="bookingform">
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="hidden" class="form-control" id="customerid" name="customerid"  value="<?=$customer_id?>">
    ...
    $("#bookingform").validate({
      ...
      rules: {
        ...
        email:{
          ...
          required: true,
          remote: {
            url: "<?php echo $config['admin_url'] ?>ajax/checkemailforupdate.php?customerid=<?= $customer_id ?>",
            type: "POST"
          }
        },
        phone:{
        ...
        username:{
          ...
          required: true,
          remote: {
            url: "<?php echo $config['admin_url'] ?>ajax/checkusernameforupdate.php?customerid=<?= $customer_id ?>",
            type: "POST"
          }
        },
        password:{
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          url : "<?php  echo $config['admin_url'] ?>ajax/edit-customer.php",
          type :"POST",
          data: form_data,
          success: function(msg){
          
           if(msg == 'customerediterror'){
              ...
              $("#form_submit").attr("disabled", true);
              $("#summary").html('<div class="alert alert-success"><p>Customer Updated !</p></div>');
              setTimeout(function(){
                window.location.reload(1);
              }, 9000);
            }
