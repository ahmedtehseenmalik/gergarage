  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'invoice.php' ?> ">Invoice</a></li>
      </ol>
    </section>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
                ...
                <?php
                  ...
                  <td><?= $row['status'] ?></td>
                  <td>  <a href="view-invoice.php?invoiceid=<?= $row['invoice_id'] ?>" > <i class="fa fa-eye fa-2x"></i> </a> </td>
                  <td>  <a href="modify-invoice.php?invoiceid=<?= $row['invoice_id'] ?>" > <i class="fa fa-pencil-square-o fa-2x"></i> </a> </td>
