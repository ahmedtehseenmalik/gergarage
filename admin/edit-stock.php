...
$stock_id = intval($_GET['stockid']);



	$stock = getonestock($stock_id);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'stocks.php' ?> ">Edit Stock</a></li>
      </ol>
    </section>
        ...
        <form  id="bookingform" name="bookingform">
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="hidden" class="form-control" id="stockid" name="stockid"  value="<?=$stock_id?>">
                <label for="itemname">Item Name*</label>
                <input type="text" class="form-control" id="itemname" name="itemname" aria-describedby="itemname" placeholder="Item Name" value="<?=$name?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="itemcost">Item Cost*</label>
                <input type="number" class="form-control" id="itemcost" name="itemcost" aria-describedby="itemcost" placeholder="Item cost" value="<?=$cost?>">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="itemquantity" name="itemquantity" aria-describedby="itemquantity" placeholder="Item Quantity" value="<?=$quantity?>">
              </div>
            </div>
  ...
  $('#form_submit').click(function(){ 
    ...
    $("#bookingform").validate({
      ...
      submitHandler: function(form) {
        ...
        $.ajax({
          url : "<?php  echo $config['admin_url'] ?>ajax/edit-stock.php",
          type :"POST",
          data: form_data,
          success: function(msg){
           
           if(msg == 'stockediterror'){
              ...
              $("#form_submit").attr("disabled", true);
              $("#summary").html('<div class="alert alert-success"><p>Stock Updated !</p></div>');
              setTimeout(function(){
                window.location.reload(1);
              }, 9000);
            }
