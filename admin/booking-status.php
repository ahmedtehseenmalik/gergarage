  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'booking-status.php' ?> ">Booking Status</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">All Assigned Bookings</h3>
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                	$resultbooking = getallAssignedBookings();
                  ...
                  <td><?= $row['status'] ?></td>
                  <td>  <a href="assign-booking-status.php?bookingid=<?= $row['booking_id'] ?>" class="ft-size"> <span class="fa fa-edit"></span> </a> </td>
                </tr>
                <?php }  } ?>
            </tbody>
              </table>
