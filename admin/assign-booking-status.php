  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'index.php' ?> ">Assign Status</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="form-group">
                <label for="availablestatus">Select Status</label>
                <select name="availablestatus" id="availablestatus"  class="form-control">
	...
	$('#form_submit').click(function(){ 
		$("#bookingform").validate({
			...
			submitHandler: function(form) {
				...
				var form_data = {
                    bookingstatus: $('#availablestatus').val(),
				...
				$.ajax({
					url : "<?php echo $config['admin_url'] ?>ajax/assign-booking-status.php",
					type :"POST",
					data: form_data,
                    success: function(msg){
                     if(msg == 'done'){
                        ...
                        $("#summary").html('<div class="alert alert-success"><p>Booking Status Updated  !</p></div>');
                        setTimeout(function(){
                            window.location.replace("<?= $config['admin_url'] . 'booking-status.php' ?>");
                        }, 9000);

                        }else{
                        
                        $("#summary").html('<div class="alert alert-danger"><p>Booking status could not be updated ! </p></div>');
                        $("#form_submit").attr("disabled", true);
                        setTimeout(function(){
