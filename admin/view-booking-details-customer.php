...
$booking=getBookingDetailsCustomer($booking_id);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'index3.php' ?> ">Booking Details</a></li>
      </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <br/>
          <a href="index3.php" class="btn btn-primary">Back</a>
        </div>
      </div>
        </form>
