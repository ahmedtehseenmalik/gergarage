  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $config['admin_url'] . 'stocks.php' ?> ">Delete Stock</a></li>
      </ol>
    </section>
...
$(document).ready(function(){
  ...
  window.location.replace("<?= $config['admin_url'] . 'stocks.php' ?>");
   });
  ...
  window.location.replace("<?= $config['admin_url'] . 'stocks.php' ?>");
   ...
   $('#btnconfirmed').click(function(){
    ...
    window.location.replace("<?= $config['admin_url'] . 'stock-delete-confirmed.php?stockid='.$stockitem_id ?>");
